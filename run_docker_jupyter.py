...
def main():
    ...
    run_command = 'docker run  -it {0}  --name {3} --rm -p 5022:22 -p 4545:4545 -v {1}:/notebooks -w /notebooks {2} jupyter'.format(
        '--net=host' if args.net_host else '', path,  args.docker_tag, 'aego')
